...
if (isset($_REQUEST['id'])) {
    $result = $modulo->getTypeMedicineById($_REQUEST['id']);
} else {
    $result = null;
}
?>
...
<html lang="en">
    <head>
        ...
        <script src="./js/FormTipomedicamento.js"></script>
    </head>
        ...
        <div class="col-md-12"> 
            ...
            <div class="card card-warning">
                <div class="card-header">
                    <h3 class="card-title">Tipo de Medicamento</h3>
                </div>
                <!-- /.card-header -->
                <div class="card-body">
                   <!-- <form>-->                     
                        ...
                        <div class="row">
                            <div class="col-sm-6">
                                ...
                                <div class="form-group">
                                    <label>Nombre</label>
                                     <input type="hidden" name="id" id="id" value="<?php echo isset($result[0]['idTypeMedicine'])?$result[0]['idTypeMedicine']:''; ?>"/>
